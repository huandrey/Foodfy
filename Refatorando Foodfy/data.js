module.exports = [
...

    {
        ...
        information: 'A receita de molho barbecue leva azeite, açúcar mascavo, mostarda e molho inglês (duas colheres de sopa cada), uma cebola ralada, uma colher de sopa de vinagre, uma xícara de chá de molho de tomate, além de sal e pimenta a gosto. Para preparar, refogue a cebola no azeite e depois misture com os outros ingredientes na panela, mexendo até encorpar. Se quiser dar um toque diferente, adicione goiabada cascão para criar essa versão de frango assado com molho barbecue de goiabada.'
    },

    {
        ...
        information: 'Recheie a lasanha com o que preferir. Quando você for preparar a massa da lasanha preste muita atenção. Siga atentamente as instruções da caixa. Não deixe mais que o tempo previsto de cozimento. Se isso acontecer, sua lasanha poderá ficar muito mole e comprometer o resultado.'
    },
        ...
        
    {
        ...
        information: 'Cuidado para não exagerar no tempo de fervura da panela de pressão. '
    }
];
